...
export const DEFAULT_STAGES: DefaultStage[] = [
  ...
  {
    name: "Agent_7 - Fact-checker",
    prompt: "Rola: Jesteś rygorystycznym fact-checkerem z dostępem do internetu. Weryfikujesz artykuł pod kątem AKTUALNOŚCI i POPRAWNOŚCI merytorycznej.\n\nDzisiejsza data: [AKTUALNA_DATA]. Wyszukując dane (przepisy, progi, stawki, ceny, statystyki, terminy), sprawdzaj stan aktualny na [AKTUALNA_DATA]. [SZUKAJ_W_INTERNECIE]\n\nZASADY WERYFIKACJI:\n1. Zgłaszaj WYŁĄCZNIE poważne nieścisłości: nieaktualne przepisy, progi lub stawki; błędne liczby zmieniające sens wypowiedzi; nieprawdziwe twierdzenia; informacje przestarzałe w stopniu wprowadzającym czytelnika w błąd.\n2. NIE zgłaszaj drobnych naciągnięć, uproszczeń redakcyjnych, zaokrągleń ani kwestii stylistycznych. W razie wątpliwości, czy problem jest poważny — pomiń go.\n3. Twoja wiedza wewnętrzna może być NIEAKTUALNA — traktuj ją wyłącznie jako hipotezę do sprawdzenia. Każde zgłoszenie MUSI wynikać z wyników wyszukiwania, nigdy z pamięci.\n\nPROTOKÓŁ WYSZUKIWANIA (obowiązkowy dla każdego potencjalnego zgłoszenia):\na) Formułuj zapytania wymuszające świeże wyniki: dodawaj bieżący rok i słowa typu „aktualne przepisy\", „nowelizacja\", np. „<temat> [AKTUALNY_ROK]\", „<akt prawny> nowelizacja [AKTUALNY_ROK]\", „<wartość> stan na [AKTUALNA_DATA]\".\nb) Dla wartości wynikających z przepisów ZAWSZE sprawdź, czy akt nie został znowelizowany w ostatnich latach — wyszukaj także zmiany/nowelizacje danego aktu i porównaj daty; obowiązuje wersja najnowsza, nie ta, którą pamiętasz.\nc) Priorytet źródeł: oficjalne teksty jednolite i strony urzędowe (ISAP/Dz.U., URE, ministerstwa, KE), następnie publikacje branżowe z widoczną datą z ostatnich 12 miesięcy. Ignoruj źródła bez daty oraz starsze, jeśli istnieją nowsze.\nd) Jeśli wyniki wyszukiwania przeczą Twojej wiedzy wewnętrznej — zaufaj najnowszemu wiarygodnemu źródłu, nie sobie.\ne) Zgłoś problem TYLKO wtedy, gdy stan aktualny na [AKTUALNA_DATA] potwierdzisz konkretnym źródłem. W polu \"powod\" podaj to źródło wraz z jego datą (np. „wg nowelizacji z 10.08.2023, Dz.U. 2023 poz. …\"). Jeśli nie możesz jednoznacznie potwierdzić stanu aktualnego — NIE zgłaszaj problemu.\n\nTEKST DO WERYFIKACJI:\n[OUTPUT_POPRZEDNI]\n\nFORMAT WYJŚCIOWY:\nZwróć WYŁĄCZNIE czysty JSON (bez znaczników formatowania typu ```json, bez komentarzy):\n{\"problemy\":[{\"paragraf\":\"...\",\"powod\":\"...\",\"poprawka\":\"...\"}]}\n\n- \"paragraf\": DOKŁADNY, dosłowny cytat fragmentu z błędem, skopiowany 1:1 z tekstu (łącznie z interpunkcją i formatowaniem Markdown) — posłuży do automatycznej podmiany w tekście.\n- \"powod\": krótkie wyjaśnienie (1-2 zdania), dlaczego to błąd, ze wskazaniem stanu aktualnego (z konkretną wartością/datą).\n- \"poprawka\": poprawna wersja całego cytowanego fragmentu, gotowa do wstawienia w miejsce błędnego (zachowaj styl i formatowanie oryginału).\n\nJeśli nie znalazłeś poważnych problemów, zwróć dokładnie: {\"problemy\":[]}",
  ...
  {
    name: "Agent_8 - Fixer (panel decyzji)",
    prompt: "[PANEL_FIXER]\nTen etap nie wywołuje modelu automatycznie. Gdy fact-checker znajdzie problemy, aplikacja zatrzymuje workflow (status „Do weryfikacji\") i pokazuje panel z listą zgłoszeń (fragment, powód, sugestia). Dla każdego zgłoszenia decydujesz: Zignoruj / Napraw wedle sugestii AI / Popraw wedle własnej sugestii. Po zastosowaniu poprawek tekst wraca do fact-checkera w celu ponownej weryfikacji.\n\nPoniższy prompt jest używany do poprawy KAŻDEGO pojedynczego, zaakceptowanego fragmentu:\n\nRola: Jesteś precyzyjnym redaktorem. Poprawiasz WYŁĄCZNIE wskazany fragment artykułu, zachowując styl, ton i formatowanie (Markdown) całości.\n\nFRAGMENT DO POPRAWY:\n[FRAGMENT_DO_POPRAWY]\n\nPOWÓD POPRAWKI:\n[POWOD_BLEDU]\n\nWYTYCZNA POPRAWKI (zastosuj jej sens):\n[SUGESTIA_POPRAWKI]\n\nPEŁNY TEKST ARTYKUŁU (wyłącznie kontekst — NIE zwracaj go i NIE zmieniaj innych fragmentów):\n[PELNY_TEKST]\n\nFORMAT WYJŚCIOWY:\nZwróć WYŁĄCZNIE poprawioną wersję wskazanego fragmentu (bez cudzysłowów, komentarzy i znaczników bloku kodu). Fragment zostanie automatycznie wstawiony w miejsce błędnego, więc musi pasować składniowo i stylistycznie do otoczenia.",
    modelCode: "gemini-3.5-flash",
    temperature: null,
    topK: null,
    topP: null,
